...
function buildNonWeapon(a: Args, itemType: string): Built {
  ...
  if (itemType === 'consumable') {
    const u = (a.uses ?? {}) as Record<string, unknown>
  ...
  if (itemType !== 'consumable' && itemType !== 'loot' && itemType !== 'container'
    && a.uses && typeof a.uses === 'object' && (a.uses as Record<string, unknown>).max !== undefined) {
    const u2 = a.uses as Record<string, unknown>
