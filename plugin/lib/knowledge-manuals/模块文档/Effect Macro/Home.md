# Effect Macro — Wiki 首页（原文）

> 来源：仓库内 `wiki/Home.md`（https://git.gay/Zhell/effectmacro 的 wiki）
> 2026-09-17 抓取，逐字保留英文原文，便于与官方对照

Effect Macro is a module that allows users to embed macros directly into effects.
